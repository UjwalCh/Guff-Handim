    ...
    <div className="h-full flex overflow-hidden">
      ...
      <div className={`flex-1 ${!activeChat ? 'hidden md:flex' : 'flex'} flex-col`}>
        {activeChat ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-wa-text_dim bg-wa-bg select-none">
            <div className="text-6xl mb-4">💬</div>
            <p className="text-xl font-light text-wa-text">Guff Handim</p>
            <p className="text-sm mt-2 text-center max-w-xs">
              Send and receive end-to-end encrypted messages. Select a chat to start.
            </p>
